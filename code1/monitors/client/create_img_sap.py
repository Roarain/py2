...
from db_swapinfo import *

# global infomation
# infomation = swapinfo().get_swap()
#
# print infomation[2:4]
...
def createChart(chartIndex):
    ...
    c.setRoundedFrame()
    c.setDropShadow()
    titlename = "Swap Used Info (Total Swap is %d)" % (infomation[0][1])
    c.addTitle(titlename, "timesbi.ttf", 15).setBackground(0xccccff, 0x000000, glassEffect())
    if chartIndex == 0 :
    #============================================================
