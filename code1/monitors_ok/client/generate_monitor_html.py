...
with open('monitor.html', 'wb+') as f:
        ...
        f.write(
            '<h1 style="background-color:red;font-family:verdana;text-align:center">Roarains Monitor Console!</h1>\n')
        f.write('<hr></hr>\n')
        ...
        f.write('<tr>')
        f.write('  <th>Load Average.Auto Refresh every 5 seconds. </th>')
        f.write('  <th>CPU Stat.Auto Refresh every 5 seconds. </th>')
        f.write('</tr>')
        f.write('<tr>')
        ...
        f.write('<h5>Swap Usage.Auto Refresh every 5 seconds. </h5>\n')
